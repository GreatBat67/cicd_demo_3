...
SCHEMAS = [
    "PATIENTS","HOSPITALS",
    "UTILITIES"]  
TARGET_DB = "CICD_demo_AUTOMATION{{env_suffix}}"
...
# Locate the dcm_automation_demo project
workspace_root = None

for parent in [current] + list(current.parents):
    if (parent / "dcm_automation_demo").exists():
        workspace_root = parent
        break

if workspace_root is None:
    raise RuntimeError("Could not locate dcm_automation_demo project.")

TARGET_ROOT = (
    workspace_root
    / "dcm_automation_demo" #change the name of project
    / "sources"
    / "definitions"
)
